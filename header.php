...
<link href='http://fonts.googleapis.com/css?family=Open+Sans|Oswald:300,400,700|Oxygen' rel='stylesheet' type='text/css' />
...
<style type="text/css">
    ...
    #az-navigationright {
        min-height: <?php echo ($customHeaderPadding+40); ?>px;
    }
    .az-sitenavr a {
    ...
    .az-sitenavr {
	   height: <?php echo ($customHeaderPadding+40); ?>px;
    }
    #az-headertagline {
